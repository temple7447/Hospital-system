    ...
    <div className="min-h-screen bg-white dark:bg-slate-950 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-semibold text-slate-900 dark:text-white tracking-tight">CareFlow</span>
            </div>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link
                ...
                className="px-6 py-2.5 bg-blue-600 text-white rounded-lg font-bold text-sm hover:bg-blue-700 transition-all  "
              >
            ...
            <div className="md:hidden">
              <Link 
                to={isAuthenticated ? "/dashboard" : "/login"} 
                className="px-5 py-2 bg-blue-600 text-white rounded-lg font-bold text-sm "
              >
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-semibold uppercase tracking-widest mb-8 border border-blue-100 dark:border-blue-900/30">
              <Globe className="w-3.5 h-3.5" />
              <span>Next Generation Hospital Management</span>
            </div>
            
            <h1 className="text-5xl lg:text-7xl font-semibold text-slate-900 dark:text-white tracking-tight mb-8 leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link 
                to={isAuthenticated ? "/dashboard" : "/login"} 
                className="w-full sm:w-auto px-8 py-4 bg-blue-600 text-white rounded-md font-semibold uppercase tracking-widest text-xs  shadow-blue-500/30 hover:bg-blue-700 transition-all  flex items-center justify-center gap-3"
              >
                {isAuthenticated ? "Enter Dashboard" : "Get Started Now"}
                <ArrowRight className="w-4 h-4" />
              </Link>
              <button className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-slate-900 text-slate-900 dark:text-white border-2 border-slate-100 dark:border-slate-800 rounded-md font-semibold uppercase tracking-widest text-xs hover:bg-slate-50 dark:hover:bg-slate-800 transition-all ">
                Watch Demo
              </button>
            </div>
            ...
            <div className="mt-16 flex flex-wrap justify-center items-center gap-12 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
              <div className="flex items-center gap-2 font-semibold text-2xl text-slate-400 italic tracking-tight">MEDICORP</div>
              <div className="flex items-center gap-2 font-semibold text-2xl text-slate-400 italic tracking-tight">HEALTHWISE</div>
              <div className="flex items-center gap-2 font-semibold text-2xl text-slate-400 italic tracking-tight">GLOBECARE</div>
              <div className="flex items-center gap-2 font-semibold text-2xl text-slate-400 italic tracking-tight">UNITYHEALTH</div>
              <div className="flex items-center gap-2 font-semibold text-2xl text-slate-400 italic tracking-tight">PURELIFE</div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="w-12 h-12 bg-white dark:bg-slate-800 rounded-md flex items-center justify-center mx-auto mb-4 shadow-sm">
                  <stat.icon className="w-6 h-6 text-blue-600" />
                </div>
                <div className="text-3xl font-semibold text-slate-900 dark:text-white mb-1">{stat.value}</div>
      ...
      <section id="features" className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-xs font-semibold text-blue-600 uppercase tracking-[0.3em] mb-4">Core Capabilities</h2>
            <h3 className="text-4xl lg:text-5xl font-semibold text-slate-900 dark:text-white tracking-tight">Everything you need to <span className="text-blue-600">modernize</span></h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="group p-8 rounded-lg bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-blue-500/30 hover: hover:shadow-blue-500/5 transition-all"
              >
                <div className={`w-14 h-14 rounded-md flex items-center justify-center mb-6 bg-slate-50 dark:bg-slate-800 group-hover:scale-110 transition-transform`}>
      ...
      <section id="solutions" className="py-24 bg-slate-900 text-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <h2 className="text-xs font-semibold text-blue-400 uppercase tracking-[0.3em] mb-4">Tailored Solutions</h2>
              <h3 className="text-4xl lg:text-6xl font-semibold tracking-tight mb-8">Unified experience for <span className="text-blue-500">every stakeholder</span></h3>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-4 rounded-md bg-white/5 border border-white/10 hover:bg-white/10 transition-all cursor-default group">
                    <div className="w-2 h-2 rounded-full bg-blue-500 group-hover:scale-150 transition-transform" />
                    <div>
                      <span className="font-semibold uppercase tracking-widest text-xs block mb-1">{item.role}</span>
              ...
              <div className="relative z-10 rounded-lg overflow-hidden  border border-white/10">
                <div className="aspect-square bg-gradient-to-br from-blue-600 to-indigo-800 p-8 flex items-center justify-center">
                  ...
                  <div className="relative z-10 grid grid-cols-2 gap-6">
                    ...
                    <div className="p-6 bg-white/10 backdrop-blur-xl rounded-lg border border-white/20 mt-12">
      ...
      <section id="about" className="py-24 bg-slate-50 dark:bg-slate-900/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-xs font-semibold text-blue-600 uppercase tracking-[0.3em] mb-4">Success Stories</h2>
            <h3 className="text-4xl lg:text-5xl font-semibold text-slate-900 dark:text-white tracking-tight">Trusted by <span className="text-blue-600">Leading Professionals</span></h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="p-8 rounded-lg bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800  shadow-slate-200/50 dark:shadow-none"
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-slate-900 dark:text-white text-sm uppercase tracking-tight">{testimonial.author}</div>
      ...
      <section className="py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-xs font-semibold text-blue-600 uppercase tracking-[0.3em] mb-4">Questions & Answers</h2>
            <h3 className="text-4xl font-semibold text-slate-900 dark:text-white tracking-tight">Frequently Asked</h3>
          </div>
          ...
          <div className="space-y-4">
            {[
              ...
              <details key={i} className="group p-6 rounded-lg bg-slate-50 dark:bg-slate-900/50 border border-slate-100 dark:border-slate-800 transition-all [&_summary::-webkit-details-marker]:hidden">
                <summary className="flex items-center justify-between cursor-pointer">
                  <h4 className="text-sm font-semibold text-slate-900 dark:text-white uppercase tracking-tight">{faq.q}</h4>
      ...
      <section className="py-24 px-4">
        <div className="max-w-5xl mx-auto rounded-lg bg-blue-600 p-12 lg:p-20 relative overflow-hidden text-center">
          <div className="relative z-10">
            <h3 className="text-4xl lg:text-5xl font-semibold text-white tracking-tight mb-8">Ready to transform your <br/>hospital operations?</h3>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link 
                to={isAuthenticated ? "/dashboard" : "/login"} 
                className="w-full sm:w-auto px-10 py-5 bg-white text-blue-600 rounded-md font-semibold uppercase tracking-widest text-xs   transition-all "
              >
                {isAuthenticated ? "Go to Dashboard" : "Start Free Trial"}
              </Link>
              <button className="w-full sm:w-auto px-10 py-5 bg-blue-700 text-white rounded-md font-semibold uppercase tracking-widest text-xs hover:bg-blue-800 transition-all">
                Contact Sales
              </button>
            </div>
          </div>
      ...
      <footer className="py-20 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            ...
            <div>
              <h4 className="font-semibold text-slate-900 dark:text-white uppercase tracking-widest text-xs mb-6">Product</h4>
            ...
            <div>
              <h4 className="font-semibold text-slate-900 dark:text-white uppercase tracking-widest text-xs mb-6">Company</h4>
              <ul className="space-y-4">
          ...
          <div className="pt-8 border-t border-slate-100 dark:border-slate-900 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="#" className="text-slate-400 hover:text-blue-600 transition-colors font-semibold text-[10px] uppercase tracking-widest">Twitter</a>
              <a href="#" className="text-slate-400 hover:text-blue-600 transition-colors font-semibold text-[10px] uppercase tracking-widest">LinkedIn</a>
              <a href="#" className="text-slate-400 hover:text-blue-600 transition-colors font-semibold text-[10px] uppercase tracking-widest">GitHub</a>
            </div>
          </div>
        </div>
      </footer>
