  ...
  return (
    <div className="space-y-8 pb-8">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Radiology, {user.name.split(' ')[0]}</h1>
      ...
      <div className="glass-card rounded-3xl p-6">
        <div className="flex items-center justify-between mb-5">
          <div>
            <h3 className="font-black text-slate-900 dark:text-white">Imaging Queue</h3>
            <p className="text-xs text-slate-400 font-bold">Sorted by priority</p>
          </div>
          <Link to="/radiology/queue" className="text-xs font-black text-blue-600 hover:text-blue-700">View all →</Link>
        </div>
